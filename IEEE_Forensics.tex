...
\author{Artur~Janicki,
        Nicholas~Evans,
        and~Federico~Alegre% <-this % stops a space
...
\thanks{N. Evans and F. Alegre are with EURECOM, Sophia Antipolis, France, e-mail: \{evans,alegre\}@eurecom.fr.}% <-this % stops a space
\thanks{The work of A. Janicki was supported by the European Union in the framework of the European Social Fund through the Warsaw University of Technology Development Programme.}% <-this % stops a space
