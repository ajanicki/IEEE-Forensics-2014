...
\thanks{A. Janicki is with the Institute of Telecommunications, Warsaw University of Technology, Warsaw, Poland, e-mail: A.Janicki@tele.pw.edu.pl.}% <-this % stops a space
...
\section{Automatic speaker verification spoofing}
...
The comparison of replay, speech synthesis and voice conversion spoofing attacks necessitates controlled experiments with a large, standard corpus, a variety of ASV systems and judicious experimental protocols.  They are described here with full details of the wider experimental setup.
